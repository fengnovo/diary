...
var cookieDomain = 'baidu.com';

 // var baseUrl = '/api';        // 开发环境
 // var baseUrl = 'http://baidu.com/test/api';      // 测试环境
var baseUrl = 'http://baidu.com/test/1.0.0';   // 生产环境

moduleApp.service('ajax', ['$http', '$q', function($http, $q){
