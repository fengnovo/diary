    ...
    E.fn.command = function (e, commandName, commandValue, callback) {
        ...
        function commandFn() {
            ...
            if (editor.queryCommandSupported(commandName)) {
                ...
                if(commandName == 'Bold' || commandName == 'Underline' || commandName == 'Italic' || commandName == 'StrikeThrough' || 
                commandName == 'RemoveFormat' || commandName == 'formatBlock' || commandName == 'InsertUnorderedList' || commandName == 'InsertOrderedList' ||
                commandName == 'JustifyLeft' ||commandName == 'JustifyCenter' ||commandName == 'JustifyRight' ||commandName == 'unLink'){
                    console.log('触发undoRecord');
                    editor.undoRecord();
                }
            } else {
                // hooks 命令
